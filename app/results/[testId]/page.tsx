    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <section className="mt-6 surface-card p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link href={`/test/${Math.min(Number(params.testId) + 1, 3)}`} className="rounded-2xl border border-[var(--border)] bg-[var(--surface2)] px-5 py-3 font-head text-lg font-bold uppercase tracking-[0.08em]">Try Test {Math.min(Number(params.testId) + 1, 3)}</Link>
