    ...
    <div className="space-y-4">
      <div className="surface-card p-6">
        ...
        <div className={`mt-5 rounded-2xl border border-[var(--border)] bg-[var(--surface2)] p-4 ${studying ? "" : "blur-sm"}`}>
          ...
          {challenge.studyType === "image" ? <div><p className="font-head text-xs uppercase tracking-[0.2em] text-[var(--muted)]">Placeholder visual</p><p className="mt-2 leading-7 text-[var(--muted)]">{challenge.studyPrompt}</p></div> : null}
        </div>
      </div>
